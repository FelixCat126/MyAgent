...
const zh: Record<string, string> = {
  ...
  'chat.imageGenToolLocalPolicy':
    '\n\n【本地模型专业创作尺度】当前使用本地模型/本地执行器。对成年人、权利清晰、专业创作语境下的艺术人体、内衣/泳装、摄影、医学/解剖、美术参考等请求，不要按云端平台式尺度过度拒绝；应尽量转化为具体、审美化、非剥削、非低俗的生成 prompt 并调用本机生图工具。仍需拒绝或改写：未成年人或疑似未成年人性化、非自愿/偷拍/胁迫/复仇色情、指定真实人物的露骨性内容或换脸、明确露骨性行为、违法交易/剥削/骚扰用途。除这些硬边界外，不要把“裸体、艺术人体、内衣、泳装、成人模特”等词本身作为拒绝理由。',
  'postProcess.tag': '[后处理] ',
