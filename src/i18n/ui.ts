...
const zh: Record<string, string> = {
  ...
  'chat.export.zip': '导出为 ZIP（含附件）',
  'chat.export.zipFailed': '导出 ZIP 失败：{detail}',
  'chat.export.zipPartial': 'ZIP 已导出，但有 {count} 个附件缺失',
  'chat.regenerate': '重新生成',
  'chat.branch.prev': '上一个分支',
  'chat.branch.next': '下一个分支',
  'settings.routing.title': '模型路由',
  'settings.routing.hint': '按条件优先选用模型；留空则忽略该规则并回退到当前模型。',
  'settings.routing.none': '（使用当前模型）',
  'chat.empty': '今天有什么想跟我聊？',
  ...
  'chat.attachmentsUploadFailed': '附件上传失败，请重试。',
  ...
  'settings.form.format.openaiImages': 'OpenAI Images 兼容（…/images/generations）',
  ...
  'settings.duckDuckGo.option': 'DuckDuckGo（免 Key）',
  'settings.web': '联网搜索',
  'settings.app': '应用与隐私',
  ...
  'settings.agentDeniedPathsPh': '~/Private\n~/Library/Keychains',
  ...
  'settings.workspacePh': '~/Documents/MyAgent知识库',
  ...
  'settings.confirmClear': '将清除本机已保存的聊天记录、设置与模型配置并刷新。确定继续？',
  ...
  'settings.speech.wakePhrasePh': '例如：小媛小媛',
  ...
  'gaze.calibration.start': '开始',
  'gaze.calibration.cancel': '取消',
  'gaze.calibration.progress': '{n} / {total}',
  'gaze.calibration.fitting': '正在拟合…',
  'gaze.calibration.successTitle': '校准完成',
  'gaze.calibration.successDesc': '如果实际指向仍有偏差，可重新校准。',
  'gaze.calibration.done': '完成',
  'gaze.calibration.failTitle': '校准失败',
  'gaze.calibration.failDesc': '未采集到足够的视线数据，请确认摄像头已开启且面部可见，然后重试。',
  'gaze.calibration.close': '关闭',
};
...
const en: Record<string, string> = {
  ...
  'chat.export.zip': 'Export as ZIP (with attachments)',
  'chat.export.zipFailed': 'ZIP export failed: {detail}',
  'chat.export.zipPartial': 'ZIP saved, but {count} attachment(s) were missing',
  'chat.regenerate': 'Regenerate',
  'chat.branch.prev': 'Previous branch',
  'chat.branch.next': 'Next branch',
  'settings.routing.title': 'Model routing',
  'settings.routing.hint': 'Prefer a model when conditions match; leave empty to skip and use the active model.',
  'settings.routing.none': '(Use active model)',
  'chat.empty': 'What would you like to talk about today?',
  ...
  'common.confirm': 'OK',
  'chat.attachmentsUploadFailed': 'Attachment upload failed. Please try again.',
  ...
  'settings.form.format.sdwebui': 'Stable Diffusion WebUI (txt2img JSON)',
  'settings.form.format.ollama': 'Ollama (/api/generate)',
  'settings.form.format.openaiImages': 'OpenAI-compatible Images (…/images/generations)',
  ...
  'settings.duckDuckGo.option': 'DuckDuckGo (no key)',
  ...
  'settings.workspacePh': '~/Documents/MyAgentKnowledge',
  ...
  'settings.confirmClear': 'This removes saved chats, settings, and model list. Continue?',
  ...
  'settings.speech.wakePhrasePh': 'e.g. hey xiaoyuan',
  'settings.speech.wakeDesc':
  ...
  'gaze.calibration.start': 'Start',
  'gaze.calibration.cancel': 'Cancel',
  'gaze.calibration.progress': '{n} / {total}',
  'gaze.calibration.fitting': 'Fitting…',
  'gaze.calibration.successTitle': 'Calibration complete',
  'gaze.calibration.successDesc': 'If accuracy is still off, you can recalibrate.',
  'gaze.calibration.done': 'Done',
  'gaze.calibration.failTitle': 'Calibration failed',
  'gaze.calibration.failDesc':
    'Insufficient gaze samples. Make sure your face is visible to the camera and retry.',
  'gaze.calibration.close': 'Close',
};
