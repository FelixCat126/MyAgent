...
const zh: Record<string, string> = {
  ...
  'settings.remoteGateway.regenerateFailed': '令牌重生成失败，请重试',
  'settings.remoteGateway.saveFailed': '保存失败，请重试',
...
const en: Record<string, string> = {
  ...
  'settings.remoteGateway.regenerateFailed': 'Failed to rotate token. Please try again.',
  'settings.remoteGateway.saveFailed': 'Save failed. Please try again.',
  'settings.remoteGateway.tokenMasked': '••••••••••••{last4}',
