...
const zh: Record<string, string> = {
  ...
  'settings.form.imageProviderPh': '请选择厂商（自动填好接口地址和模型名）',
  ...
  'settings.form.imageGenAdvanced': '高级（CLI、自定义接口、环境变量）',
...
const en: Record<string, string> = {
  ...
  'settings.form.imageProviderPh': 'Select a provider (auto-fills endpoint & model)',
  ...
  'settings.form.imageGenAdvanced': 'Advanced (CLI, custom endpoint, env vars)',
