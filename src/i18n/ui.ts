...
const zh: Record<string, string> = {
  ...
  'settings.remoteGateway.copied': '令牌已复制到剪贴板',
  'settings.remoteGateway.copyFailed': '复制失败，请手动复制',
  'settings.remoteGateway.regenerateFailed': '令牌重生成失败：{detail}',
  'settings.remoteGateway.saveFailed': '保存失败：{detail}',
  'settings.remoteGateway.tokenMasked': '••••••••••••{last4}',
  'settings.remoteGateway.showToken': '显示令牌',
  'settings.remoteGateway.hideToken': '隐藏令牌',
...
const en: Record<string, string> = {
  ...
  'chat.sendFailed': 'Send failed: {detail}',
  ...
  'settings.remoteGateway.copied': 'Token copied to clipboard',
  'settings.remoteGateway.copyFailed': 'Copy failed. Please copy manually.',
  'settings.remoteGateway.regenerateFailed': 'Failed to rotate token: {detail}',
  'settings.remoteGateway.saveFailed': 'Save failed: {detail}',
  'settings.remoteGateway.tokenMasked': '••••••••••••{last4}',
  'settings.remoteGateway.showToken': 'Show token',
  'settings.remoteGateway.hideToken': 'Hide token',
  'common.operationFailed': 'Operation failed: {detail}',
